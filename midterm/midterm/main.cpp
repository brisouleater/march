...
int main() {
	...
	while (input != 'q') {
		...
		case 1:
			...
			getline(cin, input1);
			if (input1.compare("go north") == 0) || (input1.compare("north") == 0)) {
			room = 2;
				}
			else if (input1.compare("go south") == 0)
				room = 11;
		...
		case 2:
			...
			cout << "their is so much blood here go west to see the bath tub" << endl;
			getline(cin, input1);
			if ((input1.compare("go west") == 0) || (input1.compare("west") == 0)) {
				cout << "you found a dead body! pick up the thing in the dead bodies hand" << endl;
				getline(cin, input1);
				if (input1.compare("pick up")==0)
					cout << "you now have a smelly gut! eat it to get a chicken wing" << endl;
				getline(cin, input1);
				if ((input1.compare("eat") == 0) || (input1.compare("eat chicken wing") == 0)) 
					cout << "congrats here grab your chicken wing" << endl;
				getline(cin, input1);
			 if ((input1.compare("grab") == 0) || (input1.compare("grab chicken wing") == 0)) {
		...
		case 6: cout << "you cant enter this room until u give me the sticker" << endl;
			getline(cin, input1);
			if (input1.compare("give sticker") == 0)
			...
			getline(cin, input1);
			if (input1.compare("go north") == 0)
				room = 10;
			if (input1.compare("go east") == 0)
				room = 8;
			if (input1.compare("go south") == 0)
				room = 5;
			break;
		...
		case 10:
			cout << "your in room 10,the hugs room" << endl;
